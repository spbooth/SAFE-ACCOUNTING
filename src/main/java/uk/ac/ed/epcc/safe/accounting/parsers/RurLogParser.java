...
public class RurLogParser extends AbstractPropertyContainerParser implements IncrementalPropertyContainerParser {
	...
	@AutoTable(target=String.class, length=1)
	public static final PropertyTag<String> TASKSTATS_PLUGIN = new PropertyTag<>(plugin_reg, TASKSTATS_PLUGIN_NAME, String.class);
	@OptionalTable(target=String.class, length=1)
	public static final PropertyTag<String> MEMORY_PLUGIN = new PropertyTag<>(plugin_reg, MEMORY_PLUGIN_NAME, String.class);
	@OptionalTable(target=String.class, length=1)
	...
	public static final AttributePropertyTag<Integer> NODES = new AttributePropertyTag<>(rur_reg, "nodes", null, Integer.class,
			"Number of nodes in job", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> NODES_POWER_CAPPED = new AttributePropertyTag<>(rur_reg, "nodes_power_capped", null, Integer.class,
			"Number of nodes with nonzero power cap", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> NODES_THROTTLED = new AttributePropertyTag<>(rur_reg, "nodes_throttled", null, Integer.class,
			"Number of nodes that experienced one or more throttled sockets", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> NODES_CHANGED_POWER_CAP = new AttributePropertyTag<>(rur_reg, "nodes_with_changed_power_cap", null, Integer.class,
			"Number of nodes with power caps that changed during execution, including accelerators", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> MAX_POWER_CAP = new AttributePropertyTag<>(rur_reg, "max_power_cap", null, Integer.class,
			"Maximum nonzero power cap", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> MAX_POWER_CAP_COUNT = new AttributePropertyTag<>(rur_reg, "max_power_cap_count", null, Integer.class,
			"Number of nodes with the maximum nonzero power cap", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> MIN_POWER_CAP = new AttributePropertyTag<>(rur_reg, "min_power_cap", null, Integer.class,
			"Minimum nonzero power cap", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> MIN_POWER_CAP_COUNT = new AttributePropertyTag<>(rur_reg, "min_power_cap_count", null, Integer.class,
			"Number of nodes with the minimum nonzero power cap", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> ACCEL_ENERGY_USED = new AttributePropertyTag<>(rur_reg, "accel_energy_used", null, Integer.class,
			"Total accelerator energy (in Joules) used", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> NODES_ACCEL_POWER_CAPPED = new AttributePropertyTag<>(rur_reg, "nodes_accel_power_capped",  null, Integer.class,
			"Number of accelerators with nonzero power cap", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> MAX_ACCEL_POWER_CAP = new AttributePropertyTag<>(rur_reg, "max_accel_power_cap", null, Integer.class,
			"Maximum nonzero accelerator power cap", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> MAX_ACCEL_POWER_CAP_COUNT = new AttributePropertyTag<>(rur_reg, "max_accel_power_cap_count", null, Integer.class,
			"Number of accelerators with the maximum nonzero power cap", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> MIN_ACCEL_POWER_CAP = new AttributePropertyTag<>(rur_reg, "min_accel_power_cap", null, Integer.class,
	...
	@AutoTable(target=Long.class)
	public static final AttributePropertyTag<Long> ELAPSED_TIME = new AttributePropertyTag<>(rur_reg, "etime", null, Long.class,
			"Total elapsed time in microseconds", -1L);
	@AutoTable(target=Long.class)
	public static final AttributePropertyTag<Long> SYSTEM_TIME = new AttributePropertyTag<>(rur_reg, "stime", null, Long.class,
			"System time", -1L);
	@AutoTable(target=Long.class)
	public static final AttributePropertyTag<Long> USER_TIME = new AttributePropertyTag<>(rur_reg, "utime", null, Long.class,
			"User time", -1L);
	@AutoTable(target=Long.class)
	public static final AttributePropertyTag<Long> TOTAL_IO_DELAY_TIME = new AttributePropertyTag<>(rur_reg, "bkiowait", null, Long.class,
			"Total delay time (ns) waiting for synchronous block I/O to complete", -1L);
	@OptionalTable(target=Long.class)
	public static final AttributePropertyTag<Long> HIGH_MEMORY_USED = new AttributePropertyTag<>(rur_reg, "rss", null, Long.class,
			"RSS highwater mark", -1L);
	@AutoTable(target=Long.class)
	public static final AttributePropertyTag<Long> MAX_MEMORY_USED = new AttributePropertyTag<>(rur_reg, "max_rss", null, Long.class,
			"Maximum memory used", -1L);
	@AutoTable(target=Long.class)
	public static final AttributePropertyTag<Long> MEMORY_USED_INTEGRAL = new AttributePropertyTag<>(rur_reg, "coremem", null, Long.class,
			"Integral of RSS used by process in MB-usec", -1L);
	@AutoTable(target=Long.class)
	public static final AttributePropertyTag<Long> VIRTUAL_MEMORY_INTEGRAL = new AttributePropertyTag<>(rur_reg, "vm", null, Long.class,
	...
	@AutoTable(target=Long.class)
	public static final AttributePropertyTag<Long> MINOR_PAGE_FAULT_COUNT = new AttributePropertyTag<>(rur_reg, "minfault", null, Long.class,
			"Number of minor page faults", -1L);
	@AutoTable(target=Long.class)
	public static final AttributePropertyTag<Long> MAJOR_PAGE_FAULT_COUNT = new AttributePropertyTag<>(rur_reg, "majfault", null, Long.class,
			"Number of major page faults", -1L);
	@AutoTable(target=Long.class)
	public static final AttributePropertyTag<Long> CHAR_READ_COUNT = new AttributePropertyTag<>(rur_reg, "rchar", null, Long.class,
			"Characters read by process", -1L);
	@AutoTable(target=Long.class)
	public static final AttributePropertyTag<Long> CHAR_WRITE_COUNT = new AttributePropertyTag<>(rur_reg, "wchar", null, Long.class,
			"Characters written by process", -1L);
	@AutoTable(target=Long.class)
	public static final AttributePropertyTag<Long> SYS_READ_CALLS_COUNT = new AttributePropertyTag<>(rur_reg, "rcalls", null, Long.class,
			"Number of read system calls", -1L);
	@AutoTable(target=Long.class)
	public static final AttributePropertyTag<Long> SYS_WRITE_CALLS_COUNT = new AttributePropertyTag<>(rur_reg, "wcalls", null, Long.class,
	...
	public static final AttributePropertyTag<Integer> CORE_DUMP_FLAG = new AttributePropertyTag<>(rur_reg, "core", null, Integer.class,
			"Core dump flag", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> PROCESS_EXIT_CODE = new AttributePropertyTag<>(rur_reg, "ecode", null, Integer.class,
			"Process exit code", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> NODE_SCHEDULING_DISCIPLINE = new AttributePropertyTag<>(rur_reg, "sched", null, Integer.class,
			"Scheduling discipline used on node", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> POSIX_NICE_VALUE = new AttributePropertyTag<>(rur_reg, "nice", null, Integer.class,
			"POSIX nice value of process", -1);
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> APPLICATION_ID = new AttributePropertyTag<>(rur_reg, "appid", new String[]{"apid"}, String.class,
			"Application ID as defined by application launcher", "");
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> USER_ID = new AttributePropertyTag<>(rur_reg, "uid", null, String.class,
			"User ID", "");
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> PROCESS_ID = new AttributePropertyTag<>(rur_reg, "pid", null, String.class,
			"Process ID", "");
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> JOB_ID = new AttributePropertyTag<>(rur_reg, "jid", null, String.class,
			"Job ID", "");
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> GROUP_ID = new AttributePropertyTag<>(rur_reg, "gid", null, String.class,
			"Group ID", "");
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> NODE_ID = new AttributePropertyTag<>(rur_reg, "nid", null, String.class,
			"Node ID", "");
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> PARENT_JOB_ID = new AttributePropertyTag<>(rur_reg, "pjid", null, String.class,
			"Parent job ID", "");
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> JOB_PROJECT_ID = new AttributePropertyTag<>(rur_reg, "prid", null, String.class,
			"Job project ID", "");
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> PARENT_PROCESS_ID = new AttributePropertyTag<>(rur_reg, "ppid", null, String.class,
			"Parent process ID", "");
	@OptionalTable(target=String.class)
	...
	@OptionalTable(target=Long.class)
	public static final AttributePropertyTag<Long> BOOT_FREE_MEM_CONTENTS = new AttributePropertyTag<>(rur_reg, "boot_freemem", null, Long.class,
	...
	@OptionalTable(target=Long.class)
	public static final AttributePropertyTag<Long> ACTIVE_FILE_MEM_TOTAL = new AttributePropertyTag<>(rur_reg, "meminfo_active_file", new String[]{"Active(file)"}, Long.class,
			"Total amount of memory in active use by cache and buffers", -1L);
	@OptionalTable(target=Long.class)
	public static final AttributePropertyTag<Long> INACTIVE_MEM_TOTAL = new AttributePropertyTag<>(rur_reg, "meminfo_inactive_anon", new String[]{"Inactive(anon)"}, Long.class,
			"Total amount of memory that is candidate to be swapped out", -1L);
	@OptionalTable(target=Long.class)
	public static final AttributePropertyTag<Long> INACTIVE_FILE_MEM_TOTAL = new AttributePropertyTag<>(rur_reg, "meminfo_inactive_file", new String[]{"Inactive(file)"}, Long.class,
	...
	public static final AttributePropertyTag<String> HUGEPAGES_NAME = new AttributePropertyTag<>(rur_reg, "hugepagesname", null, String.class,
			"Hugepages name", "");
	@OptionalTable(target=Long.class)
	public static final AttributePropertyTag<Long> HUGEPAGES_SIZE = new AttributePropertyTag<>(rur_reg, "hugepagessize", null, Long.class,
			"Hugepages size", -1L);
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> HUGEPAGES_SIZE_UNIT = new AttributePropertyTag<>(rur_reg, "hugepagessizeunit", null, String.class,
			"Number of hugepages that exist at this point", "");
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> HUGEPAGES_COUNT = new AttributePropertyTag<>(rur_reg, "hugepages_nr", new String[]{"nr"}, Integer.class,
			"Number of hugepages that exist at this point", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> SURPLUS_HUGEPAGES_COUNT = new AttributePropertyTag<>(rur_reg, "hugepages_surplus", new String[]{"surplus"}, Integer.class,
			"Number of hugepages above nr", -1);
	@OptionalTable(target=Integer.class)
	public static final AttributePropertyTag<Integer> UNALLOCATED_HUGEPAGES_COUNT = new AttributePropertyTag<>(rur_reg, "hugepages_free", new String[]{"free"}, Integer.class,
	...
	public static final AttributePropertyTag<String> NODEZONES_NAME = new AttributePropertyTag<>(rur_reg, "nodezonesname", null, String.class,
			"Nodezones name", "");
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> NODEZONES_NUMBER = new AttributePropertyTag<>(rur_reg, "nodezonesnumber", null, String.class,
			"Nodezones number", "");
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> NODEZONES_TYPE = new AttributePropertyTag<>(rur_reg, "nodezonestype", null, String.class,
			"Nodezones type", "");
	 ...
	 */
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> ERROR_TRACEBACK = new AttributePropertyTag<>(rur_reg, "error_traceback", new String[]{"traceback"}, String.class,
			"Stack frame list", "");
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> ERROR_TYPE = new AttributePropertyTag<>(rur_reg, "error_type", new String[]{"type"}, String.class,
			"Python exception type", "");
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> ERROR_VALUE = new AttributePropertyTag<>(rur_reg, "error_value", new String[]{"value"}, String.class,
			"Python exception parameter", "");
	@OptionalTable(target=String.class)
	public static final AttributePropertyTag<String> ERROR_NID = new AttributePropertyTag<>(rur_reg, "error_nid", new String[]{"nid"}, String.class,
