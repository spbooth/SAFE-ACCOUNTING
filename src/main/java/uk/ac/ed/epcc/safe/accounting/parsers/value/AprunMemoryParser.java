...
public class AprunMemoryParser implements ValueParser<Long> {
    private static final Pattern patt = Pattern.compile("(\\d+)\\s*([kmg]?)h?s?",Pattern.CASE_INSENSITIVE);
	private static final long K=1024L;
	private static final long M=K*K;
	private static final long G=K*M;
	public static AprunMemoryParser PARSER = new AprunMemoryParser();
