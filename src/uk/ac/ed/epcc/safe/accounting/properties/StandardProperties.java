...
public class StandardProperties {
	...
	public static final PropertyTag<String> USERNAME_PROP = new PropertyTag<>(base,"UserName",String.class,"The username using the resource");
	public static final PropertyTag<String> GROUPNAME_PROP = new PropertyTag<>(base,"GroupName",String.class,"The unix groupname of the primary group using the resource");
	public static final PropertyTag<String> WORKING_DIR = new PropertyTag<>(base,"CWD",String.class,"Full working directory of resource use");
	public static final PropertyTag<String> COMMAND = new PropertyTag<>(base,"Command",String.class,"Executed command, optionally with command arguments");
	public static final PropertyTag<String> EXECUTABLE = new PropertyTag<>(base,"Executable",String.class,"Executed command");
	public static final PropertyTag<Integer> EXIT_PROP = new PropertyTag<>(base,"Exit",Integer.class,"Numerical exit status of job or command");
	public static final PropertyTag<String> ERROR_PROP = new PropertyTag<>(base,"Error",String.class,"Error string returned from Job");
	...
	public static final PropertyTag<Long> COUNT_PROP = new PropertyTag<>(time,"JobCount",Long.class,"Number of Jobs");
	 ...
	 */
	public static final PropertyTag<String> TABLE_PROP = new PropertyTag<>(time,"Table",String.class,"Table record stored in");
	static{
		time.lock();
		base.lock();
	}
