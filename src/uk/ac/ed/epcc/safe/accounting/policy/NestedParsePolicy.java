...
public class NestedParsePolicy extends BaseUsageRecordPolicy implements SummaryProvider {
	...
	public void getTableTransitionSummary(ContentBuilder hb, SessionService operator) {
		...
		Table t = new Table();
		t.put("Value", "link_prop_name", link_prop_name);
		
		t.put("Value", "nested_prop", nested_prop == null ? "Unset" : nested_prop.getFullName());
