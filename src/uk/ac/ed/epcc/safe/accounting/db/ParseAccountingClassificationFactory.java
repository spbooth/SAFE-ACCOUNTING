 ...
 * @author spb
 *
 * @param <T> type of {@link Classification}
 * @param <R> IR type of {@link PropertyContainerParser}
 */


public class ParseAccountingClassificationFactory<T extends Classification,R>
extends PropertyClassificationFactory<T> {
	ClassificationUploadParseTargetPlugin<T, R> parse_plugin = new ClassificationUploadParseTargetPlugin<>(this);
