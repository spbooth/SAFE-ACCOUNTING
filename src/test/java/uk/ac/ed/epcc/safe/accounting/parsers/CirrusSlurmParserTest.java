...
public class CirrusSlurmParserTest extends AbstractRecordTestCase {

	


	public CirrusSlurmParserTest() {
		super("Cirrus","CirrusSlurm");
	}
	...
	private static final String testDataPath = "./cirrus_acct.txt";
