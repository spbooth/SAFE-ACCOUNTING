...
public class MapperEntryInputTestCase extends WebappTestBase implements TestDataProvider<String, MapperEntryInput> ,
ListInputInterfaceTest<String, MapperEntry, MapperEntryInput, TestDataProvider<String,MapperEntryInput>>
{
	...
	public MapperEntryInput getInput() throws Exception {
		...
		return new MapperEntryInput(getContext(), serv.getUsageProducer(), null);
	}
