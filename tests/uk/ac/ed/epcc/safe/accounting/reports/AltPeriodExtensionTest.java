...
public class AltPeriodExtensionTest extends ExtensionTestCase {
	...
	public void testOneSixMonthSplit() throws Exception {	
		testPeriod("testSinglePeriod.xml","csv", new File(getOutputDir()+"OneSixMonthSplit.csv"));

	}
	@Test
	@DataBaseFixtures({"Eddie.xml"})
	public void testOneHourPeriod() throws Exception {	
		testPeriod("testSinglePeriod.xml","csv", new File(getOutputDir()+"OneHourPeriod.csv"));
	...
	protected void testPeriod(String template,String reportType, File outputFile) throws Exception {
		testPeriod(template,reportType, TestDataHelper.readFileAsString(outputFile));
		
	}
	
	private void testPeriod(String type, String expectedOutput) throws Exception {		
		testPeriod("testAltPeriod.xml",type,expectedOutput);
	}
